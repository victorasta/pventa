    ...
    <div class="site-wrapper-inner">
        ...
        <div class="cover-container">
            ...
            <div class="inner cover">
                <h1 class="cover-heading">Gracias por su preferencia</h1>
                <p class="lead">No olvide visitarnos pronto.</p>
                <p class="lead">Si esta contento con nuestro servicio, por favor comparta su experiencia con sus amigos.</p>
