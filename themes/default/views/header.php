...
<div class="wrapper rtl rtl-inv">
    ...
    <header class="main-header">
        <a href="<?= site_url(); ?>" class="logo">
            ...
            <span class="logo-lg"><?= $store->name == 'Punto Venta' ? 'Punto<b>Venta</b>' : $store->name; ?></span>
            <?php } else { ?>
            <span class="logo-mini">POS</span>
            <span class="logo-lg"><?= $Settings->site_name == 'Punto Venta' ? 'Punto<b>Venta</b>' : $Settings->site_name; ?></span>
            <?php } ?>
        </a>
